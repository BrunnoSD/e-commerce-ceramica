...
function CardsColecao() {
  ...
  const produto = [
    ...
    {sku: "0003", imagem: tresimg, nomeproduto: "Vaso Cerâmico Branco", preco: "R$ 40,00"},
    {sku: "0004", imagem: quatroimg, nomeproduto: "Caneca Vulcânica", preco: "R$ 25,00"},
    {sku: "0005", imagem: quintoimg, nomeproduto: "Caneca Texturizada", preco: "R$ 38,00", situacao: "Mais vendido"},
    {sku: "0006", imagem: sextoimg, nomeproduto: "Caneca Serenity", preco: "R$ 18,00"},
    {sku: "0007", imagem: setimoimg, nomeproduto: "Jarro Minimalista", desconto: "R$ 130,00", preco: "R$ 100,00",situacao: "Promoção"},
    {sku: "0008", imagem: oitavoimg, nomeproduto: "Conjunto de Bowls", preco: "R$ 45,00"},
  ...
  return (
    <main className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-5 mx-5">
      {produto.map((produtos, index) => (
        <section key={index} className="relative group cursor-pointer lg:duration-500 lg:hover:scale-102">
